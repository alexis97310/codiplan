 ...
 * texte pour vérifier que le littéral ci-dessous vaut la même chose. Une
 * seconde constante qui diverge en silence (§9, 01/09) serait ici invisible à
 * `pnpm typecheck` ; c'est le gardien qui la voit.
 */
