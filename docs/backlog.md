...
*Relu contre les sources citées le 11/09/2026 — empreinte `070cbf40`.*
...
*File :* BLOQUÉ — le report groupé n'est pas spécifié, et sa lecture décide s'il reste dix lignes ou un moteur de placement (issue #142). Mesuré le 11/09/2026.
...
*Acceptation :* à écrire avec la réponse.
*Relu contre les sources citées le 11/09/2026 — empreinte `121d4111`.*
