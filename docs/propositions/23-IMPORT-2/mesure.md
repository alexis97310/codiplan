...
Mesuré le 2026-09-22T17:28:02.844Z, sur `Linux Alexis 6.18.33.2-microsoft-standard-WSL2 #1 SMP PREEMPT_DYNAMIC Thu Jun 18 21:54:43 UTC 2026 x86_64 GNU/Linux`, Node v22.23.2, psql (PostgreSQL) 18.6 (Ubuntu 18.6-0ubuntu0.26.04.1).
...
|---|---|---|---|
| creation | 100 | 90.8 | 749909 ms |
| creation | 300 | 160.5 | 749839 ms |
| creation | 600 | 319.6 | 749680 ms |
| creation | 1000 | 507.9 | 749492 ms |
| creation | 2000 | 987.6 | 749012 ms |
| creation | 4000 | 1956.2 | 748044 ms |
| creation | 8000 | 3859.2 | 746141 ms |
| modification | 100 | 160.9 | 749839 ms |
| modification | 300 | 354.6 | 749645 ms |
| modification | 600 | 611.1 | 749389 ms |
| modification | 1000 | 1052.6 | 748947 ms |
| modification | 2000 | 1911.2 | 748089 ms |
| modification | 4000 | 3609.7 | 746390 ms |
| modification | 8000 | 7455.1 | 742545 ms |

## Pente mesurée, et extrapolation — PAS une mesure directe

- créations : 0.4770 ms/ligne, socle 43.1 ms. casserait DUREE_MAXIMALE_MS vers 1 572 194 lignes (extrapolé, jamais atteint par cette mesure).
- modifications : 0.9233 ms/ligne, socle 68.6 ms. casserait DUREE_MAXIMALE_MS vers 812 212 lignes (extrapolé, jamais atteint par cette mesure).

Pour comparaison, ce que le BUDGET théorique de `allersRetoursApplication` (lib/imports/delais.ts) prévoit, sous `LATENCE_PESSIMISTE_MS` = 500 ms : casse au-delà de 746 lignes retenues (résolution de `allersRetoursApplication(n) × LATENCE_PESSIMISTE_MS ≤ DUREE_MAXIMALE_MS`).
